...
const PAGES = [
  ...
  { key: 'brand-story', label: 'Câu Chuyện', sections: ['hero', 'vision', 'architecture', 'gallery'] },
  { key: 'lifestyle-events', label: 'Sự Kiện Cá Nhân', sections: ['hero', 'gallery', 'events'] },
  { key: 'business-events', label: 'Sự Kiện DN', sections: ['hero', 'gallery', 'events'] },
